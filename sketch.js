...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if (invisibleGround.x < 0){
      invisibleGround.x = invisiblegGround.width/2;
    }
...
function spawnClouds() {
  ...
  if (frameCount % 100 === 0) {
    var cloud = createSprite(random(600,300),120,40,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(random(600,300) ,165,10,40);
    //obstacle.debug = true;
